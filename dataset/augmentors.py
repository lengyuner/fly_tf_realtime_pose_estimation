...
def joints_to_point8(joints, num_p=5):#TODO(JZ)18
    """
...
def point8_to_joints(points, num_p=5):
# def point8_to_joints(points, num_p=18):#TODO(JZ)18
    """
